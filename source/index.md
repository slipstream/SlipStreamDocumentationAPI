...
<aside class="notice">
Immutable runs cannot be changed once deployed. If you require to scale up or down the run, then request a <em>mutable</em> run (see below).
</aside>

<aside class="notice">
This mutable/immutable feature only applies to deployment type run (aka <em>Orchestration</em> type).
</aside>
...
<aside class="notice">
Only <em>Orchestration</em> type run can be created as mutable.
</aside>
